...
export const crawler = async () => {
    ...
    // 打開目標網頁
    await page.goto('https://www.macromicro.me/charts/5479/tw-backlog-of-orders-customers-invertories', {
    ...
    const screenshotPath = path.resolve(PICS_DIR, 'TaiwanUnfulfilledOrdersReduceCustomerInventory_screenshot.png');
