...
export const crawler = async () => {
    ...
    // 打開目標網頁
    await page.goto('https://www.macromicro.me/charts/13940/tai-wan-tai-gu-ben-yi-bi-yu-tai-gu-qu-shi', {
    ...
    const screenshotPath = path.resolve(PICS_DIR, 'TaiwanPeRatio_screenshot.png');
